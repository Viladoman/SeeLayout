  ...
  submenu: [
    { label: 'Quick Guide', click: function () {
      dialog.showMessageBox(null, {
        type: 'info',
        title: 'See++ Memory Layout Viewer',
        message: 'Quick Guide',
    ...
    { label: 'Documentation', click: function () { shell.openExternal('https://github.com/Viladoman/SeeLayout/wiki') }, accelerator: 'CommandOrControl+F1' },
    { type: 'separator' },
    { label: 'Github', click: function () { shell.openExternal('https://github.com/Viladoman/SeeLayout') } },
    ...
    { label: 'About', click: function () {
      dialog.showMessageBox(null, {
        type: 'info',
        title: 'See++ Memory Layout Viewer',
        message: 'See++ Memory Layout Viewer',
